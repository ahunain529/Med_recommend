...
# Load your model (assuming you've saved it as 'svc.pkl')
svc = pickle.load(open("models/svc.pkl", 'rb'))

# Load your datasets and other necessary files
...
def predict():
    if request.method == 'POST':
        ...
        return render_template('result.html', disease=dis, description=desc, precautions=pre, medications=med, diets=diet, workout=wrkout)
